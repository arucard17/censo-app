...
function toFirestoreDoc(registro: LocalRegistro) {
  ...
  const doc: Record<string, unknown> = {
    ...
    discapacidadEnfermedad: merged.discapacidadEnfermedad.trim(),
    discapacidadTiempo: merged.discapacidadTiempo.trim(),
    discapacidadCuidadorNombre: merged.discapacidadCuidadorNombre.trim(),
    discapacidadCuidadorTelefono: merged.discapacidadCuidadorTelefono.trim(),
    localId: merged.id,
    source: 'pwa-sonsito',
